...
DATA_PATH=/workdir/data/wikipedia_20220301.en/wikipedia_20220301.en.train.jsonl_text_document
#DATA_PATH=/workdir/data/OpenHermes-2.5/openhermes2_5.jsonl
TOKENIZER_MODEL=/workdir/tokenizer/tokenizer_llama2
...
run_cmd="
    torchrun $DISTRIBUTED_ARGS /workdir/megatron-versions/Megatron-LM-rocm-dev/pretrain_gpt.py \
        $GPT_ARGS \
        $DATA_ARGS \
        $OUTPUT_ARGS \
        $EXTRA_ARGS \
